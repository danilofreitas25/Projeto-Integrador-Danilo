...
<br>
<br>
        <table class="table table-bordered border-warning" border="15px">
        <tr>
            <th>Nome</th>
            <th>Nota</th>
            <th>Tipo</th>
...
while($linha = mysqli_fetch_array($rs)){
        ...
        <tr><td><a class="btn btn-success"  href="painel.php">Voltar para o painel</a></td></tr>
        ...
        echo"<br><a class='btn btn-warning'  href='cadastroceva.php'>Cadastre sua Cerveja</a>";
    }
